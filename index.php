...
<body>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6 col-lg-6">
                    <div class="single_delicious d-flex align-items-center">
                        ...
                        <div class="info">
                            <h3>Beefy Burgers</h3>
                            <p>Отличный способ сделать вашу компанию заслуживающей доверия и актуальной.</p>
                            <span>$5</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="room_thumb">
                    ...
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            ...
                            <p>Отличный способ сделать вашу компанию заслуживающей доверия <br> и актуальной.</p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-lg-5 offset-lg-1 col-md-6">
                    <div class="about_info">
                        ...
                        <p>Существует множество вариаций отрывков Lorem Ipsum, но большинство из них претерпело
                            изменения в той или иной форме из-за привнесенного юмора или случайных слов, которые не
                            выглядят даже немного правдоподобно. Если вы собираетесь использовать отрывок из Lorem
                            Ipsum, вам нужно быть уверенным, что в середине текста не спрятано ничего смущающего. Все
                            генераторы Lorem Ipsum в Интернете имеют тенденцию повторять заранее определенные фрагменты
                            по мере необходимости, что делает его первым настоящим генератором в Интернете. Для
                            генерации он использует словарь, содержащий более 200 латинских слов, в сочетании с
                            несколькими моделями структур предложений.</p>
                        <div class="img_thumb">
    ...
    <div class="video_area video_bg overlay">
        <div class="video_area_inner text-center">
            <h3>Бургер <br>
                Бакалавр</h3>
            <span>Как мы делаем вкусный бургер</span>
